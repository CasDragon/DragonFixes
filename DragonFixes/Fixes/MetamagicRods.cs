...
namespace DragonFixes.Fixes
{
    internal class MetamagicRods
    {
        ...
        public static void PatchPiercingRods()
        {
            ...
            LibraryStuff.RemoveComponent<MetamagicRodMechanics>(normal);
            ...
            LibraryStuff.RemoveComponent<MetamagicRodMechanics>(lesser);
            ...
            LibraryStuff.RemoveComponent<MetamagicRodMechanics>(greater);
