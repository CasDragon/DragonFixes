        ...
        public static void InitializeSettings()
        {
            ModMenu.ModMenu.AddSettings(
                SettingsBuilder.New(RootKey, CreateString(GetKey("es-title"), "Eldritch Scion"))
                    ...
                    .AddToggle(
                        Toggle.New(GetKey("lessercelestialtotem"), defaultValue: true, CreateString("lessercelestialtotem-toggle", "Fix Lesser Celestial Totem from procing on 0 hp heals")))
